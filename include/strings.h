...
extern const u8 gText_CantUseUntilHaveHM[];
...
extern const u8 gText_EggFromOldMan[];
...
extern const u8 gText_WelcomeToHOFNormalNoMGM[];
extern const u8 gText_WelcomeToHOFNormalMGM[];
extern const u8 gText_WelcomeToHOFEasyNoMGM[];
extern const u8 gText_WelcomeToHOFEasyMGM[];
