...
static const u8 sText_PkmnFrostbittenBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1} frostbit {B_EFF_NAME_WITH_PREFIX}!");
...
static const u8 sText_123Poof[] = _("1, {PAUSE 10}2, and{PAUSE 10}… {PAUSE 10}… {PAUSE 20}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p");
...
static const u8 sText_FoePkmnPrefixLower[] = _("foe ");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNFROSTBITTENBY - BATTLESTRINGS_TABLE_START] = sText_PkmnFrostbittenBy,
    ...
    [STRINGID_PKMNMAKESROCKMISS - BATTLESTRINGS_TABLE_START] = sText_PkmnMakesRockMiss,
...
const u16 gMissStringIds[] =
{
    ...
    [B_MSG_ROCK_MISS]   = STRINGID_PKMNMAKESROCKMISS
};
...
const u8 gText_BattleMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Fight{CLEAR_TO 56}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Bag\n{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Pokémon{CLEAR_TO 56}Run");
...
const u8 gText_BattleDawnName[] = _("Dawn");
const u8 gText_BattleRoarkName[] = _("Roark");
const u8 gText_BattleGardeniaName[] = _("Gardenia");
const u8 gText_BattleFantinaName[] = _("Fantina");
const u8 gText_BattleMayleneName[] = _("Maylene");
const u8 gText_BattleWakeName[] = _("Wake");
const u8 gText_BattleByronName[] = _("Byron");
const u8 gText_BattleCandiceName[] = _("Candice");
const u8 gText_BattleVolknerName[] = _("Volkner");
