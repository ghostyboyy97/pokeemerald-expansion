...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_BEAT_UP] =
    {
        ...
        .description = COMPOUND_STRING(
            "User attacks, bullying\n"
            "the target 2 to 5 times."),
        .effect = EFFECT_MULTI_HIT,
        .power = 25,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_DARK_HOLE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_DarkHole,
    },
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument = 50, // restores 100% HP instead of 50% HP, changed
        .mirrorMoveBanned = B_UPDATED_MOVE_FLAGS < GEN_8,
        .metronomeBanned = TRUE,
        .healingMove = B_HEAL_BLOCKING >= GEN_6,
    ...
    [MOVE_SNIPE_SHOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ignores redirection with\n"
            "a very high crit rate."),
