...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_LECHONK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 16, SPECIES_OINKOLOGNE_M},
                                {EVO_LEVEL_FEMALE, 16, SPECIES_OINKOLOGNE_F}),
    },
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .abilities = { ABILITY_EARLY_BIRD,  ABILITY_HARVEST,  ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ARBOLIVA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SEED_SOWER,  ABILITY_HARVEST,  ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_ARMAROUGE},
                                {EVO_ITEM, ITEM_MOON_STONE, SPECIES_CERULEDGE}),
    },
    ...
    [SPECIES_WATTREL] =
    {
        ...
        .abilities = { ABILITY_STATIC,  ABILITY_VOLT_ABSORB,  ABILITY_COMPETITIVE },
    ...
    [SPECIES_MABOSSTIFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE,  ABILITY_DEFIANT,  ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FLITTLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SPEED_BOOST,  ABILITY_FRISK,  ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BRUTE_BONNET] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PROTOSYNTHESIS,  ABILITY_NONE,  ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SANDY_SHOCKS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PROTOSYNTHESIS,  ABILITY_NONE,  ABILITY_WATER_COMPACTION },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] =
    {
        ...
        .abilities = { ABILITY_HEATPROOF,  ABILITY_NONE,  ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_GREEN,
...
#if P_FAMILY_OGERPON
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform, rzMode)   \
    {                                                                                                                  \
        .baseHP        = 80,                                                                                           \
        .baseAttack    = 120,                                                                                          \
        .baseDefense   = 84,                                                                                           \
        ...
        .growthRate = GROWTH_SLOW,                                                                                     \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                                                     \
        .abilities = { ability,  ABILITY_NONE,  ability },                                                                     \
        .bodyColor = color,                                                                                            \
    ...
    [SPECIES_OGERPON_TEAL]             = OGERPON_SPECIES_INFO(Teal,        Teal,            TYPE_GRASS, ABILITY_DEFIANT,                        BODY_COLOR_GREEN, 1, 7, 1, FALSE, MON_RANDOMIZER_NORMAL),
    [SPECIES_OGERPON_WELLSPRING]       = OGERPON_SPECIES_INFO(Wellspring,  Wellspring,      TYPE_WATER, ABILITY_WATER_ABSORB,                   BODY_COLOR_BLUE,  1, 7, 0, FALSE, MON_RANDOMIZER_INVALID),
    [SPECIES_OGERPON_HEARTHFLAME]      = OGERPON_SPECIES_INFO(Hearthflame, Hearthflame,     TYPE_FIRE,  ABILITY_MOLD_BREAKER,                   BODY_COLOR_RED,   1, 7, 0, FALSE, MON_RANDOMIZER_INVALID),
    [SPECIES_OGERPON_CORNERSTONE]      = OGERPON_SPECIES_INFO(Cornerstone, Cornerstone,     TYPE_ROCK,  ABILITY_STURDY,                         BODY_COLOR_GRAY,  1, 7, 0, FALSE, MON_RANDOMIZER_INVALID),
#if P_TERA_FORMS
    [SPECIES_OGERPON_TEAL_TERA]        = OGERPON_SPECIES_INFO(Teal,        TealTera,        TYPE_GRASS, ABILITY_EMBODY_ASPECT_TEAL_MASK,        BODY_COLOR_GREEN, 0, 0, 1, TRUE, MON_RANDOMIZER_INVALID),
    [SPECIES_OGERPON_WELLSPRING_TERA]  = OGERPON_SPECIES_INFO(Wellspring,  WellspringTera,  TYPE_WATER, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK,  BODY_COLOR_BLUE,  0, 0, 0, TRUE, MON_RANDOMIZER_INVALID),
    [SPECIES_OGERPON_HEARTHFLAME_TERA] = OGERPON_SPECIES_INFO(Hearthflame, HearthflameTera, TYPE_FIRE,  ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK, BODY_COLOR_RED,   0, 0, 0, TRUE, MON_RANDOMIZER_INVALID),
    [SPECIES_OGERPON_CORNERSTONE_TERA] = OGERPON_SPECIES_INFO(Cornerstone, CornerstoneTera, TYPE_ROCK,  ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, BODY_COLOR_GRAY,  0, 0, 0, TRUE, MON_RANDOMIZER_INVALID),
#endif //P_TERA_FORMS
