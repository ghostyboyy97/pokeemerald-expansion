...
static void PrintTitleWindowText(int hoennOffset, int flyOffset);
...
static void FieldUpdateRegionMap(void)
{
    int hoennOffset = GetStringCenterAlignXOffset(FONT_NORMAL, gText_Hoenn, 0x38);
    int flyOffset = GetStringCenterAlignXOffset(FONT_NORMAL, FlyPromptText, 0x38);
    ...
    switch (sFieldRegionMapHandler->state)
    {
        ...
        case 1:
            ...
            PrintTitleWindowText(hoennOffset, flyOffset);
