...
const u8 gText_WelcomeToHOF[] = _("Welcome to the Hall of Fame!\nPokémon Emerald Imperium v1.3.1");
const u8 gText_WelcomeToHOFNormalNoMGM[] = _("Welcome to the Hall of Fame!\nEmerald Imperium 1.3.1 Normal");
const u8 gText_WelcomeToHOFNormalMGM[] = _("Welcome to the Hall of Fame!\nEmerald Imperium 1.3.1 Normal / MGM");
const u8 gText_WelcomeToHOFEasyNoMGM[] = _("Welcome to the Hall of Fame!\nEmerald Imperium 1.3.1 Easy");
const u8 gText_WelcomeToHOFEasyMGM[] = _("Welcome to the Hall of Fame!\nEmerald Imperium 1.3.1 Easy / MGM");
...
const u8 gText_LeagueChamp[] = _("Pokémon Emerald Imperium v1.3.1:\nLeague Champion, congratulations!");
...
const u8 gText_InfiniteRepelOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Repel");
const u8 gText_InfiniteRepelOff[] = _("{COLOR RED}{SHADOW LIGHT_RED}Repel");
...
const u8 gText_CantUseUntilHaveHM[] = _("This can't be used until the\nHM03 is obtained.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_WhichTypeRelearn[] = _("Relearn which moves?");
...
const u8 gText_EggFromOldMan[] = _("An odd Pokémon EGG\nobtained from an old man.");
...
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Slo");
...
const u8 gText_FollowersOff[] = _("{COLOR RED}{SHADOW LIGHT_RED}Follower");
